	...
	<table width=100%>
		<tr>
			<td align="center"><h2>당신만을 위한 오리엔탈 프리미엄 에디션</h2> The Oriental
				Premium Edition for You<br></td>
		</tr>
		
		<tr>
			<td align="center"><img alt="호텔정보"
				src="/remedium/image/info.jpg" size="100%" style=" border-bottom:solid 5px #A2D5FF; margin-top:10px;
		...
		<tr>
			...
			<td align="center">
				...
				<hr align="left" width="80" size="2" color="#A2D5FF" >&nbsp;일상에 지친
